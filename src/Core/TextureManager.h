...
public:
	...
	static void DrawS(SDL_Texture *tex, const Vector2D &pos, const Vector2D &size, SDL_Rect src);
	static void DrawEx(SDL_Texture *tex, const Vector2D &pos, const Vector2D &size, const int &angle, SDL_RendererFlip flip = SDL_FLIP_NONE);
